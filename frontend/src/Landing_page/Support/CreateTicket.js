    ...
    return (
        <div className="container mt-5 p-5">
            ...
            <div className="row offset-1">
                ...
                <div className="col-4">
                    <p><i class="fa-solid fa-chart-simple"></i>&nbsp;&nbsp;Kite</p>
                    <ul style={{ lineHeight: "1.8" }}>
                        <li><a href=''>IPO
                        </a></li>
                        <li><a href=''>
            ...
            <div className="row offset-1">
                <div className="col-4">
                    <p><i class="fa-solid fa-wallet"></i>&nbsp;&nbsp; Funds</p>
                    <ul style={{ lineHeight: "1.8" }} >
                        <li><a href=''>Resident individual</a></li>
                        <li><a href=''>Resident individual</a></li>
                        <li><a href=''>Resident individual</a></li>
                ...
                <div className="col-4">
                    <p><i class="fa-solid fa-info"></i>&nbsp;&nbsp; Console</p>
                    <ul style={{ lineHeight: "1.8" }} >
                        <li><a href=''>Portfolio
                        </a></li>
                ...
                <div className="col-4">
                    <p><i class="fa-solid fa-coins"></i>&nbsp;&nbsp; Coin</p>
                    <ul style={{ lineHeight: "1.8" }} >
